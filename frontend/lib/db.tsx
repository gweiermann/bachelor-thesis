        ...
        chapters: [
            {
                ...
                tasks: [
                    ...
                    { id: "insertion-sort", title: "Insertion Sort", status: 'completed', description: 'Lorem Ipsum...' },
                    { id: "selection-sort", title: "Selection Sort", status: 'in-progress', description: 'Lorem Ipsum...' },
                ]
            },
            {
                ...
                progress: 0,
                tasks: [
                    { id: "quick-sort", title: "Quick Sort", status: 'not-started', description: 'Lorem Ipsum...' },
                    { id: "merge-sort", title: "Merge Sort", status: 'not-started', description: 'Lorem Ipsum...' },
                ]
            },
        ],
    }
