        ...
        chapters: [
            {
                ...
                tasks: [
                    ...
                    },
                    {
                        id: "insertion-sort",
                        presetName: 'sort',
                        functionPrototype: 'void insertionSort(int* arr, int n)',
                    ...
                    },
                    {
                        id: "selection-sort",
                        presetName: 'sort',
                        functionPrototype: 'void selectionSort(int* arr, int n)',
            ...
            },
            {
                ...
                tasks: [
                    {
                        id: "quick-sort",
                        presetName: 'recursive-sort',
                        functionPrototype: 'void quickSort(int* arr, int low, int high)',
                        title: "Quick Sort", 
                        status: 'not-started',
                        description: 'Lorem Ipsum...'
                    },
                    { 
                        id: "merge-sort",
                        presetName: 'recursive-sort',
                        functionPrototype: 'void mergeSort(int* arr, int left, int right)',
                        title: "Merge Sort",
                        status: 'not-started',
                        description: 'Lorem Ipsum...'
                    },
